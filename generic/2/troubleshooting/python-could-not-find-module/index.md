---
title: 'Python: Could not find module "libparamonte" (or one of its dependencies)'
#tags: 
keywords: 
        troubleshooting
        mpi
...
```python  
Could not find module 'libparamonte.dll' (or one of its dependencies). Try using the full path with constructor syntax.
...
FileNotFoundError: Could not find module 'C:\Users\cmbac\AppData\Roaming\Python\Python38\site-packages\paramonte\libparamonte.dll' (or one of its dependencies). Try using the full path with constructor syntax.
```  
